...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Здравствуйте ," + '\n' + "Программа в вашем распоряжении" + '\n' + "Напишите exit для выхода");
        ...
        program(scanner, genres, authors, books);
...
//
    ...
    public static Author takeVariable(Scanner scanner, String name, String surname) {
        ...
        switch (variable) {
            ...
            case ("Нет"):
                break;
            default:
                System.out.println("Команды нету такой, введите Да или Нет");
    ...
    public static Book addBookToCollection(List<Book> books, List<Genre> genres, List<Author> authors, Scanner scanner) {
        if (genres.size() == 0) {
            System.out.println("Вы не можете добавить книгу, не добавив жанры");
            return null;
        }
        ...
        Author author = null;
        if (authors.size() == 0) {
            System.out.println("Не может быть книги без автора");
            return null;
        }
        for (Author value : authors) {
        ...
        if (author == null) {
            System.out.println("Автора такого нету. Может хотите создать нового автора," + '\n' + "или Нет?");
            author = takeVariable(scanner, authorName, authorSurname);
            if (author == null) {
                System.out.println("Без автора нельзя создать книгу");
                return null;
            }
        }
    ...
    public static void program(Scanner scanner, List<Genre> genres, List<Author> authors, List<Book> books) {
        while (true) {
